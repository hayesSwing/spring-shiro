...
public class IdWorkerUtils {
    ...
    private final static Logger logger = LoggerFactory.getLogger(IdWorkerUtils.class);
    ...
    private static IdWorkerUtils flowIdWorker = new IdWorkerUtils(1);
...
//
//        IdWorkerUtils idWorker = IdWorkerUtils.getFlowIdWorkerInstance();
